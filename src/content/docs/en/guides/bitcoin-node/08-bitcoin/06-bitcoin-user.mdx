...
Be sure to copy the line starting with `rpcauth` which contains the hash of your RPC password. We'll be pasting this line in the Bitcoin config file in the section.
