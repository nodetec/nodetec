---
label: Command Line
slug: en/guides/bitcoin-node/operating-system/command-line
order: 20
---
...
The command line is the main way we'll be interacting with the node, so it's important to at least understand the basics.
...
Now that we know the basics of using the command line, we're ready to verify the authenticity of the downloaded image.
