...
After verifying the authenticity of the image, we're now ready to extract the image to an external media device, e.g., a USB and proceed with the installation.
